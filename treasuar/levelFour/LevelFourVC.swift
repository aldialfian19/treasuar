...
class LevelFourVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        floorEntitya2 = try! Entity.load(named: "grass")
        floorEntitya3 = try! Entity.load(named: "grass")
        floorEntitya4 = try! Entity.load(named: "balok")
        
        floorEntityb1 = try! Entity.load(named: "balok")
...
//        arView.debugOptions = .showAnchorGeometry
    ...
    func checkPoint(){
        ...
        if roundedValue1 == 0.0 && roundedValue2 == 0.0{
            print("robot in a1")
        }else if roundedValue1 == 0.2 && roundedValue2 == 0.0 {
            print("robot in a2")
...
extension LevelFourVC: UITableViewDataSource, UITableViewDelegate {
